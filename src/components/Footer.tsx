...
export default function Footer() {
  return (
    <footer className="bg-[#06070a] border-t border-white/5 pt-16 pb-8 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex space-x-4 pt-2">
            <a href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-[#090a0f] transition-all duration-300">
              <Facebook className="w-4 h-4" />
            </a>
            <a href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-accent hover:text-white transition-all duration-300">
        ...
        {/* Quick Links column */}
        <div className="flex flex-col space-y-4">
          <h4 className="text-white font-semibold font-display text-base tracking-wide">
            Quick Links
          </h4>
          <ul className="space-y-3">
            {[
              ...
              <li key={idx}>
                <Link href={link.path} className="text-gray-400 hover:text-primary text-sm flex items-center group transition-all">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-white/5 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 gap-4">
